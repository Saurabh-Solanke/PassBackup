document.addEventListener("DOMContentLoaded", () => {
  ...
  function saveDraft(sectionIndex, sectionData) {
    const draft = {
      id: generateNewId(drafts),
      draftid: generateNewId(drafts),
      userid: activeUser.id,
      section1: {},
      section2: {},
      section3: {},
    ...
    draft[`section${sectionIndex}`] = sectionData;

    drafts.push(draft);
    localStorage.setItem("drafts", JSON.stringify(drafts));
    alert(`Draft for section ${sectionIndex} saved!`);
  }
  ...
  document.getElementById("nextButton2").addEventListener("click", () => {
    const section2Data = {
      ...
      known_by_other_names: document.querySelector(
        'input[name="known_by_other_names"]:checked'
      ).value,
      aliases: document.getElementById("aliases").value,
      changed_name: document.querySelector('input[name="changed_name"]:checked')
        .value,
      ...
      parent_spouse_government_servant: document.querySelector(
        'input[name="parent_spouse_government_servant"]:checked'
      ).value,
      education: document.getElementById("education").value,
      non_ecr: document.querySelector('input[name="non_ecr"]:checked').value,
  ...
  document.getElementById("nextButton6").addEventListener("click", () => {
    const section6Data = {
      criminal_proceedings_1: document.querySelector(
        'input[name="criminal_proceedings_1"]:checked'
      ).value,
      court_name_1: document.querySelector('input[name="court_name_1"]').value,
      case_number_1: document.querySelector('input[name="case_number_1"]')
        .value,
      law_section_1: document.querySelector('input[name="law_section_1"]')
        .value,
      criminal_proceedings_2: document.querySelector(
        'input[name="criminal_proceedings_2"]:checked'
      ).value,
      court_name_2: document.querySelector('input[name="court_name_2"]').value,
      case_number_2: document.querySelector('input[name="case_number_2"]')
        .value,
      law_section_2: document.querySelector('input[name="law_section_2"]')
        .value,
      criminal_proceedings_3: document.querySelector(
        'input[name="criminal_proceedings_3"]:checked'
      ).value,
      court_name_3: document.querySelector('input[name="court_name_3"]').value,
      case_number_3: document.querySelector('input[name="case_number_3"]')
        .value,
      law_section_3: document.querySelector('input[name="law_section_3"]')
        .value,
      criminal_proceedings_4: document.querySelector(
        'input[name="criminal_proceedings_4"]:checked'
      ).value,
      court_name_4: document.querySelector('input[name="court_name_4"]').value,
      case_number_4: document.querySelector('input[name="case_number_4"]')
        .value,
      law_section_4: document.querySelector('input[name="law_section_4"]')
        .value,
      criminal_convictions: document.querySelector(
        'input[name="criminal_convictions"]:checked'
      ).value,
      court_name_5: document.querySelector('input[name="court_name_5"]').value,
      case_number_5: document.querySelector('input[name="case_number_5"]')
        .value,
      conviction_date: document.querySelector('input[name="conviction_date"]')
        .value,
      refused_passport_1: document.querySelector(
        'input[name="refused_passport_1"]:checked'
      ).value,
      refusal_reason: document.querySelector('input[name="refusal_reason"]')
        .value,
      refused_passport_2: document.querySelector(
        'input[name="refused_passport_2"]:checked'
      ).value,
      impounded_passport_number: document.querySelector(
        'input[name="impounded_passport_number"]'
      ).value,
      impounding_reason: document.querySelector(
        'input[name="impounding_reason"]'
      ).value,
      refused_passport_3: document.querySelector(
        'input[name="refused_passport_3"]:checked'
      ).value,
      revoked_passport_number: document.querySelector(
        'input[name="revoked_passport_number"]'
      ).value,
      revocation_reason: document.querySelector(
        'input[name="revocation_reason"]'
      ).value,
      granted_citizenship_1: document.querySelector(
        'input[name="granted_citizenship_1"]:checked'
      ).value,
      region_country_granted: document.querySelector(
        'input[name="region_country_granted"]'
      ).value,
      granted_citizenship_2: document.querySelector(
        'input[name="granted_citizenship_2"]:checked'
      ).value,
      region_country_held: document.querySelector(
        'input[name="region_country_held"]'
      ).value,
      granted_citizenship_3: document.querySelector(
        'input[name="granted_citizenship_3"]:checked'
      ).value,
      surrendered_passport_number: document.querySelector(
        'input[name="surrendered_passport_number"]'
      ).value,
      granted_citizenship_4: document.querySelector(
        'input[name="granted_citizenship_4"]:checked'
      ).value,
      application_details: document.querySelector(
        'input[name="application_details"]'
      ).value,
      application_place: document.querySelector(
        'input[name="application_place"]'
      ).value,
      surrendered_passport_1: document.querySelector(
        'input[name="surrendered_passport_1"]:checked'
      ).value,
      ec_no: document.querySelector('input[name="ec_no"]').value,
      ec_issue_date: document.querySelector('input[name="ec_issue_date"]')
        .value,
      issuing_authority: document.querySelector(
        'input[name="issuing_authority"]'
      ).value,
      return_date: document.querySelector('input[name="return_date"]').value,
      return_region: document.querySelector('input[name="return_region"]')
        .value,
      ec_reason: document.querySelector('input[name="ec_reason"]').value,
      surrendered_passport_2: document.querySelector(
        'input[name="surrendered_passport_2"]:checked'
      ).value,
      deported_details: document.querySelector('input[name="deported_details"]')
        .value,
      surrendered_passport_3: document.querySelector(
        'input[name="surrendered_passport_3"]:checked'
      ).value,
      repatriated_details: document.querySelector(
        'input[name="repatriated_details"]'
      ).value,
    };
  ...
  document.getElementById("saveDraftButton1").addEventListener("click", () => {
    ...
    saveDraft(1, section1Data);
  });

  document.getElementById("saveDraftButton2").addEventListener("click", () => {
    const section2Data = {
      given_name: document.getElementById("given_name").value,
      surname: document.getElementById("surname").value,
      known_by_other_names: document.querySelector(
    ...
    saveDraft(2, section2Data);
  });

  document.getElementById("saveDraftButton3").addEventListener("click", () => {
    const section3Data = {
      father_given_name: document.getElementById("father_given_name").value,
      father_surname: document.getElementById("father_surname").value,
      mother_given_name: document.getElementById("mother_given_name").value,
    ...
    saveDraft(3, section3Data);
  });

  document.getElementById("saveDraftButton4").addEventListener("click", () => {
    const section4Data = {
      present_house_street: document.getElementById("present_house_street")
        .value,
      present_town: document.getElementById("present_town").value,
    ...
    saveDraft(4, section4Data);
  });

  document.getElementById("saveDraftButton5").addEventListener("click", () => {
    const section5Data = {
      emergency_contact_name: document.getElementById("emergency_contact_name")
        .value,
      emergency_contact_address: document.getElementById(
    ...
    saveDraft(5, section5Data);
  });

  document.getElementById("saveDraftButton6").addEventListener("click", () => {
    const section6Data = {
      criminal_proceedings_1: document.querySelector(
        'input[name="criminal_proceedings_1"]:checked'
      ).value,
    ...
    saveDraft(6, section6Data);
  });

  document.getElementById("saveDraftButton7").addEventListener("click", () => {
    const section7Data = {
      declaration_place: document.getElementById("declaration_place").value,
      declaration_date: document.getElementById("declaration_date").value,
